...
class _GalleryState extends State<Gallery> {
  ...
  void _about() => showWin98MessageBox(
        context: context,
        title: 'About',
        message: 'win98_ui gallery',
      );
          ...
          children: [
            Win98GroupBox(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Win98Checkbox(
                    value: _checked, label: 'Checkbox', onChanged: (v) => setState(() => _checked = v)),
  ...
  Widget _dialogs() => Wrap(spacing: 6, runSpacing: 6, children: [
